            ...
            <div class="menu">
                <ul>
                    ...
                    if (isset($_SESSION['id']) && $_SESSION['id']){
                        $tdn=$_SESSION['id'];
                        echo "<li id='tdn'>Chào mừng $tdn đến với FOODSEARCH | Email: hotrofoodsearch@gmail.com</li>";
                        echo "<a id='dx' href=xu_li/dangxuat.php><li>&ensp;<image id=image src=imags/dang_xuat.png> Đăng xuất</li></a>";
                    }
                    else{
                        echo "<li>Chào mừng bạn đến với FOODSEARCH | Email: hotrofoodsearch@gmail.com</li>";
            ...
            <div class="center_left">
                ...
                <div class="center_right">
                    ...
                    <div class="mon_an">
                        ...
                        $result = $conn->query("SELECT * FROM thuc_an th, thich t where id='$tdn' and th.ten=t.ten") or die("Lỗi truy vấn");
