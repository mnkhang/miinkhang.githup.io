	...
	<div class="drapper">
		<div class="top">
			...
			<div class="menu">
				<ul>
					...
					if (isset($_SESSION['id']) && $_SESSION['id']){
						...
						echo "<li>Chào mừng bạn đến với Gusto | Email: Gusto@gmail.com</li>";
			...
			<div class="center_left">
				<center><h1>Món Hot</h1></center>
				<div class="slides">
					<a href="#"><img class='slide' src="imags/ca_hap.jpg" height="190px" width="300px"></a>
					<a href="#"><img class='slide' src="imags/com_hs.jpg" height="190px" width="300px"></a>
					<a href="#"><img class='slide' src="imags/mon_kho.jpg" height="190px" width="300px"></a>
				...
				<div class="center_right">
					...
					<div class="mon_an">
						...
						$result = $conn->query("SELECT * FROM thuc_an") or die("Lỗi truy vấn");
                        ...
                        $ten=$row["ten"];
                        $ten_mh=urlencode( base64_encode( $ten ) );
                        $luot_xem=$row["luot_xem"];
                        echo "<td><a href='chitiet.php?ten=$ten_mh'>";
                        ...
                        if($result2->num_rows==0){
                        	echo "<a href = 'xu_li/like.php?ten=$ten_mh'><img src='imags/dislike.jpg' style='width:20px;height:20px; margin-top:5px;'> Love</a>";
                        	echo "<h5>".$result3->num_rows." người     </h5>";
                        }
                        else {
                        	echo "<a href = 'xu_li/dislike.php?ten=$ten_mh' style='color:red'><img src='imags/like.jpg' style='width:20px;height:20px;margin-top:5px;'> Love</a>";
